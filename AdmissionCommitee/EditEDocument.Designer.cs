namespace AdmissionCommitee
{
    partial class EditEDocument
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "EditEDocument";
            this.Text = "Редактировать документ об образовании";
            this.Load += new System.EventHandler(this.EditEDocument_Load);
